...
hs.hotkey.bind( hyper_split, ',', function()
	hs.application.frontmostApplication():selectMenuItem({'File'})
end)
hs.hotkey.bind( hyper_split, '.', function()
	hs.application.frontmostApplication():selectMenuItem({'Window'})
end)
hs.hotkey.bind( hyper_split, '/', function()
...
hs.hotkey.bind({'alt', 'cmd', 'shift'}, 'e', function()
	fastType('gcoakley@datarecognitioncorp.com')
end)
